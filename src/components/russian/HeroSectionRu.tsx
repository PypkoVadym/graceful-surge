        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            <span className="inline-block py-1 px-3 mb-5 text-xs font-medium tracking-wider text-primary bg-accent rounded-full">
              Премиальный эстетический уход
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold mb-6 tracking-tight">
              Гармония природной красоты и современной хирургии
            </h1>
            <p className="text-muted-foreground text-lg mb-8 max-w-xl">
              Каждая женщина заслуживает чувствовать себя гармонично в собственном теле. Моя задача — помочь достичь этого через эстетическую коррекцию фигуры, подтяжку живота, естественную пластику груди или коррекцию носа. Без преувеличений — только то, что усиливает вашу силу и уверенность.
            </p>
          ...
          <div className="relative animate-slide-in">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-xl shadow-lg animate-scale-in">
              ...
              <p className="text-xs text-muted-foreground">Пластический хирург</p>
            </div>
          </div>
        </div>
      </div>
