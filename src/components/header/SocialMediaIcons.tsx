...
const SocialMediaIcons = ({ size = 20, className = "" }: SocialMediaIconsProps) => {
  return (
    <div className={`flex items-center space-x-4 ${className}`}>
      ...
      <a href="https://threads.net" target="_blank" rel="noopener noreferrer" 
         className="text-gray-600 hover:text-primary transition-colors" 
         aria-label="Threads">
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-600">
