  ...
  return (
    <div className={`flex items-center space-x-${isMobile ? '6' : '4'} ${isMobile ? 'justify-center mt-6 pt-6 border-t border-gray-100' : ''}`}>
      ...
      >
        ...
        >
          <path
            d="M7.5 12C7.5 9.51 9.51 7.5 12 7.5C14.49 7.5 16.5 9.51 16.5 12C16.5 14.49 14.49 16.5 12 16.5"
            stroke="currentColor"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M16.5 12C16.5 14.49 14.49 16.5 12 16.5C9.51 16.5 7.5 14.49 7.5 12"
            stroke="currentColor"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M8.44 7.5C6.48 8.74 5.25 10.97 5.25 13.5V19.5"
            stroke="currentColor"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      >
        ...
        >
          <path
            d="M16.5 8.25C14.7051 8.25 13.25 6.79493 13.25 5V4.75H10.75V15C10.75 16.2426 9.74264 17.25 8.5 17.25C7.25736 17.25 6.25 16.2426 6.25 15C6.25 13.7574 7.25736 12.75 8.5 12.75"
            stroke="currentColor"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M16.5 4.75C18.5711 4.75 20.25 6.42893 20.25 8.5V19.25H17.75"
            stroke="currentColor"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
