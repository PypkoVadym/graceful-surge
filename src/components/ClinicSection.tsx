      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            ...
            Клініка поєднує надійність з найсучаснішими медичними технологіями, створюючи не просто атмосферу комфорту — а простір, де про ваше здоров’я дбають на найвищому рівні.
            </p>
            ...
            <div className="space-y-6 mb-8">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                  Працюємо за найвищими медичними стандартами та використовуємо лише перевірені сучасні препарати для анестезії з метою створити простір, де пацієнти почуваються впевнено, спокійно та комфортно.
                  </p>
                </div>
              </div>
